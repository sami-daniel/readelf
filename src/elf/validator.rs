pub mod elf64bitvalidator {
    use elf64bitvalidationerrors::Elf64BitETypeValidationErrors;
    ...
    impl<'a> Elf64BitValidator<'a> {
        ...
        pub fn validate_e_ident(&mut self) -> Result<(), elf64bitvalidationerrors::Elf64BitEIdentValidationErrors> {
        ...
        pub fn validate_e_type(&self) -> Result<(), Elf64BitETypeValidationErrors> { // the e_type field uses u16, that occuppes 2 bytes, so we have to cast to apropriatte endiannes
            if self.base.len() < 18 {
            ...
            let e_type = match endianness {
                ...
                _ => return Err(elf64bitvalidationerrors::Elf64BitETypeValidationErrors::InvalidEndianness(endianness)),
            };
    ...
    pub mod elf64bitvalidationerrors {
        ...
        pub enum Elf64BitEIdentValidationErrors {
            ...
            Non64BitELF(u8),
            #[error("The ELF file e_ident version cannot be setted to other value different of 1. See https://refspecs.linuxfoundation.org/ for more info")]
            InvalidELFVersion(u8),
            #[error("The ELF file e_ident describes an invalid endiannes value (`{0}`)")]
            InvalidEndianness(u8),
            #[error("The ELF file e_ident dont describes an right padding for ELF file, witch should be 0 for the 9 byte to the 15 ")]
            InvalidPadding,
        }
...
mod tests {
    ...
    mod test_validate_e_type {
        use super::super::elf64bitvalidator::Elf64BitValidator;
        use super::super::elf64bitvalidator::elf64bitvalidationerrors::Elf64BitETypeValidationErrors;
    ...
    mod test_validate_e_ident_tests {
        use super::super::elf64bitvalidator::Elf64BitValidator;
        use super::super::elf64bitvalidator::elf64bitvalidationerrors::Elf64BitEIdentValidationErrors;
